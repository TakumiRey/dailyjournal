  ...
  <body class="bg-danger-subtle">
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        if ($userInput === $username && $passInput === $password) {
            echo "<div class='mt-4 alert alert-success alert-custom text-center'>
                    <p><strong>User:</strong> admin</p>
                    <p><strong>Pass:</strong> 123456</p>
                    <p>Username dan Password <strong>Benar</strong></p>
                  </div>";
        } else {
            echo "<div class='mt-4 alert alert-warning alert-custom text-center'>
                    <p><strong>User:</strong> admin</p>
                    <p><strong>Pass:</strong> 123456</p>
                    <p>Username dan Password <strong>Salah</strong></p>
                  </div>";
        }
    }
    ?>
